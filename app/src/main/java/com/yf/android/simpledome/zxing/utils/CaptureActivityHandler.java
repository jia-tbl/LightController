...
package com.yf.android.simpledome.zxing.utils;
...
import com.yf.android.simpledome.zxing.activity.InterFragment;
...
public class CaptureActivityHandler extends Handler {
    ...
    private final InterFragment fragment;
    private final DecodeThread decodeThread;
    private final CameraManager cameraManager;
    private State state;

    public CaptureActivityHandler(InterFragment fragment, CameraManager cameraManager, int decodeMode) {
